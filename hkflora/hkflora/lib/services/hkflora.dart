...
class FloraDataList {
  ...
  final List<FloraData> data;
    ...
    factory FloraDataList.fromJson(Map<String, dynamic> jsonData){
      ...
      return FloraDataList(data: (jsonData[jsonDataKey] as List).map((e) => FloraData.fromJson(e as Map<String, dynamic>)).toList());
} 
}
...
class FloraData {
  FloraData({
    ...
    factory FloraData.fromJson(Map<String, dynamic> data){
      ...
      final rareAndPreciousPlantsOfHk = data['Rare and Precious Plants of HK (Status in China)'] ;
      ...
      final flowerFromValue = (data['flowerFromValue'] is int)? data['flowerFromValue'] : null;
      final flowerToValue = (data['flowerFromValue'] is int)? data['flowerToValue'] : null;
      final fruitFromValue = (data['fruitFromValue'] is int)? data['fruitFromValue'] : null; 
      final fruitToValue = (data['fruitToValue'] is int)? data['fruitToValue'] : null;
      return FloraData(speciesId: speciesId, 
                       familyId: familyId, 
                       familyNo: familyNo, 
